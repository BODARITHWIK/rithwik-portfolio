...
import { Award, Sparkles, Eye, X, ExternalLink, ShieldCheck } from "lucide-react";
  ...
  const certificates = [
    {
      ...
      description:
        "Validates foundational knowledge of cloud concepts, core Microsoft Azure services, cloud governance, privacy, security, and pricing models.",
    },
    {
      id: "oracle",
      image: "/oracle.jpg",
      ...
      description:
        "Certifies advanced competency in automating CI/CD pipelines, container orchestration, microservices deployment, and infrastructure management on OCI.",
    },
    {
      id: "linguaskill",
      image: "/linguaskill.jpg",
      title: "Linguaskill Certification – Cambridge University",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base leading-relaxed text-slate-300 sm:text-lg">
            Recognized certifications validating specialized knowledge in Cloud Computing, DevOps Automation, and Professional Competence.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {certificates.map((cert, idx) => (
            <motion.div
              ...
              className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/10 bg-slate-900/60 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400/50 hover:bg-slate-900/90 hover:shadow-2xl hover:shadow-cyan-950/40"
            >
              <div>
              ...
              <div className="p-6 pt-0">
                <button
                  onClick={() => setSelectedCert(cert)}
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-cyan-400/40 bg-cyan-500/10 px-4 py-2.5 text-xs font-bold text-cyan-300 transition-all duration-300 hover:bg-cyan-400 hover:text-slate-950 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)]"
                >
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            ...
            >
              {/* Modal Header */}
              <div className="flex items-center justify-between border-b border-white/10 px-6 py-4 bg-slate-950/90">
