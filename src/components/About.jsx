  ...
  return (
    <section id="about" className="relative py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Section Header with Brand Emblem Showcase */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="grid gap-8 lg:grid-cols-[1fr_320px] lg:items-center"
        >
          ...
          <div className="relative group rounded-3xl border border-amber-400/40 bg-black/90 p-5 shadow-[0_0_35px_rgba(245,158,11,0.25)] backdrop-blur-2xl transition-all duration-500 hover:border-amber-400/70 hover:shadow-[0_0_45px_rgba(245,158,11,0.4)] flex flex-col items-center justify-center text-center">
            <div className="relative mb-3">
              <img
                src="/logo.png"
                alt="Boda Rithwik Personal Brand Logo Emblem"
                className="h-44 w-44 object-contain filter drop-shadow-[0_0_20px_rgba(245,158,11,0.5)] transition-transform duration-500 group-hover:scale-105"
              />
            </div>
            <div className="space-y-1">
              <div className="text-sm font-black tracking-widest text-amber-300 uppercase font-outfit">
                BODA RITHWIK
              </div>
              <div className="text-xs font-semibold text-slate-300 font-mono">
                Official Monogram Emblem
              </div>
            </div>
          </div>
        </motion.div>
