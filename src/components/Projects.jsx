...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      number: "03",
      title: "Serverless E-Commerce Recommendation System",
      subtitle: "Event-Driven AI Recommendation Engine",
      category: "Serverless & Cloud",
      description:
        "High-performance serverless architecture leveraging AWS Lambda and DynamoDB to deliver personalized product recommendations dynamically with near-zero latency.",
      technologies: [
        "React",
        "AWS Lambda",
        "API Gateway",
    ...
    },
    {
      id: "format-validator",
      number: "04",
      title: "PAN & Aadhaar Format Validator",
      subtitle: "Identity Verification Microservice API",
      category: "Backend & Microservices",
      description:
        "RESTful API service for validating official Indian identity document formats (PAN card & Aadhaar card) with regex rules, instant response payloads, and database logging.",
      technologies: [
        "Java",
        "Spring Boot",
        "REST API",
